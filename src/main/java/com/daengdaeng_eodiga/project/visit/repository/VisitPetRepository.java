...
public interface VisitPetRepository extends JpaRepository<VisitPet, Integer> {
	...
	@Query("SELECT vp FROM VisitPet vp WHERE vp.visit.place = :place and vp.visit.visitAt = :visitAt")
	List<VisitPet> findByPlaceIdAndVisitAt(Place place, LocalDateTime visitAt);
}
